            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="numberID" class="col-md-4 col-form-label text-md-right">{{ __('numberID') }}</label>

                            <div class="col-md-6">
                                <input id="numberID" type="text" class="form-control @error('numberID') is-invalid @enderror" name="numberID" value="{{ old('numberID') }}" >
